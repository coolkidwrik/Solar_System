...
function addSunLight() {
  const sunWorldRadius = sun.scale.x+ 0.1;
  const sunLight1 = new THREE.PointLight(0xffffff);
  const sunLight2 = new THREE.PointLight(0xffffff);
  const sunLight3 = new THREE.PointLight(0xffffff);
  const sunLight4 = new THREE.PointLight(0xffffff);
  const sunLight5 = new THREE.PointLight(0xdddddd);
  const sunLight6 = new THREE.PointLight(0xdddddd);
...
function updatePlanetPositions() {
  updateSunPosition();
  // updateEarthAndMoonPosition(); // TODO: fix this
}
